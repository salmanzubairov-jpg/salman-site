...
const required = ['operatorDetailsVerified','privacyPolicyReviewed','hostingAndLogsReviewed','incidentAndTokenRevokeHandled','assetRightsReviewed','ownerApprovedProduction'];
